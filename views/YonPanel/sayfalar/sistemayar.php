<?php require 'views/YonPanel/header.php'; ?>
     ...
     <!--  FORMUN İSKELETİ-->
            ...
            <div class="col-xl-15 col-md-12  text-center"> 
       ...
       <div class="row text-center">  
        	 ...
        	 <div class="col-lg-10 col-xl-10 col-md-6 mx-auto">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                    		<div class="row">
                            		...
                            		<div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 bloklararasi">
                                    		<div class="row">
 					<div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Üst 1</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">
					 ...
					 "method" => "POST"						
					  ...
					  ?>
                   	...
                   	<div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Alt 1</div>
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Üst 2</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">
                    <?php 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Alt 2</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Üst 3</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Slogan Alt 3</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
					  ...
					  ?></div>  
												 ...
												 <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Üyeler Sayfalama Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
					  ...
					  ?></div> 
												 <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Üyeler Arama Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
										
 	 					Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"uyeSayfaAramaAdet","value"=>$veri["sistemayar"][0]["uyelerAramaAdet"]));	   	 
					 
					 
					  ?></div>
									 <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Ürünler Sayfalama Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
										
 	 					Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"urunlerSayfaGorAdet","value"=>$veri["sistemayar"][0]["urunlerGoruntuAdet"]));	   	 
					 
					 
					  ?></div><div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Ürünler Arama Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
										
 	 					Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"urunAramaAdet","value"=>$veri["sistemayar"][0]["urunlerAramaAdet"]));	   	 
					 
					 
					  ?></div>
								
												 <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Ürünler Kategori Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
					  ...
					  ?></div>
												 <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">SİTE- Ürünler Görüntü Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
					  ...
					  ?></div>
												<div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">PANEL- Üye Panel Yorum Adet</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">  <?php 
	 ...
	 if (isset($veri["Urunekleme"])) :
	  ...
	  ?>
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 ...
        	 <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> SİSTEM GÜNCELLE </h1></div>
        	 ...
        	 <div class="col-lg-10 col-xl-10 col-md-6 mx-auto">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                    		<div class="row">
                            		...
                            		<div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 bloklararasi">
                                    		<div class="row">
 					<div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Ürün Adı</div>
                    <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 uruneklemeElemanlarDiger">
                        	 <?php 	
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"urunad"));	   	 
					  ...
					  ?>
                   	...
                   	<div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Kategori</div>
	...
	Form::OlusturOption(array("value"=>$deger["id"]),false,$deger["ad"]);		
			...
			endforeach;		
			 ...
			 Form::OlusturSelect("2",null);	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Kumaş</div>
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"kumas"));	   	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Üretim yeri</div>
                    <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">  <?php 
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"uretimyeri"));	   	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Renk</div>
                    <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">  <?php 
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"renk"));	   	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Fiyat</div>
                    <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">  <?php 
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"fiyat"));	   	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Stok</div>
                    <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">  <?php 
 	 ...
 	 Form::Olustur("2",array("type"=>"text","class"=>"form-control","name"=>"stok"));	   	 
                    ...
                    <div class="col-lg-7 col-xl-7 col-md-5 col-sm-12 uruneklemeElemanlar">Durum</div>
                    <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">
                    <?php
