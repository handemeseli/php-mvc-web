<?php require 'views/YonPanel/header.php'; ?>
	 ...
	 // SİPARİŞLERİN TÜMÜNÜN GÖRÜNDÜĞÜ YER
      ...
      <!-- BAŞLIK -->
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 	...
        	 	<div class="col-lg-4 col-xl-4 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> İADE SİPARİŞLER </h1></div>
           		<div class="col-lg-8 col-xl-8 col-md-12 mb-12 p-2"><h1 class="h3 mb-0 text-gray-800">
					<?php if (count($temizsiparisnumaralari)==0): echo "";
						  else: echo "Onay Bekleyen siparişler :". count($temizsiparisnumaralari);
						  endif; ?></h1></div>  
      ...
      <!-- BAŞLIK --> 	
        ...
        <?php if (count($temizsiparisnumaralari)==0): ?>
		  
		  <div class="row arkaplan p-1 mt-2 pb-0">
			  
                 	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                          
						<div class="alert alert-danger">ONAY BEKLEYEN SİPARİŞ İADE TALEBİ YOK</div>
		  ...
		  <?php else: 
	  		...
	  		foreach ($temizsiparisnumaralari as $value) :
				...
				array("siparisler.kargodurum As kargodurum",
        		 ...
        		 <div class="row arkaplan p-1 mt-2 pb-0">
                    ...
                    <span>Tarih :</span> <span class="spantext"><?php echo $veriler[0]["tarih"]; ?></span>
					 ...
					 <div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 geneltext bg-gradient-mvc" id="detaygoster">
						 ...
						 <a class="btn btn-dark p-1" data-value="<?php echo $value; ?>" data-value2="<?php echo $veriler[0]["adresid"]; ?>" data-toggle="modal" 
                    ...
                    <a data-value="<?php echo $value; ?>" class="btn btn-sm btn-success btn-block mb-1">ONAYLA</a>
			...
			$toplam=array();		 
						foreach($urunlerial as $deger):
						 ...
						 echo '	<div class="row border border-light">     
								...
								<div class="col-lg-3 text-dark kalinyap p-2">'.$deger["urunadet"].' ADET</div>
								<div class="col-lg-3 text-dark kalinyap p-2">'.number_format($deger["urunfiyat"],2,",",".").'₺</div>
								<div class="col-lg-3 text-dark kalinyap p-2">'.number_format($deger["toplamfiyat"],2,",",".").'₺</div>             
                     			</div> ';
