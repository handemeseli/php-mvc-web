 ...
 <div class="row text-left border-bottom-mvc mb-2 arama-bg-gradient"> 
	 ...
	 ?>
		  ...
		  <?php 
				...
				echo '<div class="alert-danger p-2 mt-5"><h4 class="pt-3">LÜTFEN ARAMA KRİTERİ SEÇİNİZ</h4></div>';				
	 ...
	 // SİPARİŞLERİN TÜMÜNÜN GÖRÜNDÜĞÜ YER
	  ...
	  Session::set("numaralar",$son);
		  ...
		  echo '<div class="alert-danger p-1 mt-1">'.$veri["aramakriter"].' 
		  <a href="'.URL.'/panel/siparisExcelAl" class="btn btn-primary btn-sm">EXCELE AKTAR</a></div>';	
