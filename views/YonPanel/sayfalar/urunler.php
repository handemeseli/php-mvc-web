					...
					<div class="col-lg-10 col-xl-10 col-md-6 mx-auto">             
						<div class="row bg-gradient-beyazimsi">             
							...
							<!-- İÇ ANASI -->
          					...
          					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeBtn"><?php
			 				Form::Olustur("2",array("type"=>"submit","value"=>"ÜRÜN EKLE","class"=>"btn btn-primary"));	
							Form::Olustur("kapat");	 ?></div>					
						</div> 
						<!-- ROWWW -->
...
//************************************************************** ÜRÜN ANA EKRAN ***********************************************************
			...
			<div class="row text-left border-bottom-mvc mb-2">       
				...
				<div class="dropdown shop">
								<a class="btn btn-sm btn-mvc dropdown-toggle mt-1 pt-2" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-hashpopup="true" aria-expanded="false">YÖNETİM</a>
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										<a class="dropdown-item" href="<?php echo URL; ?>/panel/Urunekleme"><i class="fas fa-plus text-primary "></i> Ürün Ekle</a>
										<a class="dropdown-item" href="<?php echo URL; ?>/panel/topluurunekle"><i class="fas fa-upload text-success "></i> Toplu Ürün Ekle</a>
										<a class="dropdown-item" href="<?php echo URL; ?>/panel/topluurunguncelleme"><i class="fas fa-retweet text-warning "></i> Toplu Ürün Güncelle</a>
										<a class="dropdown-item" href="<?php echo URL; ?>/panel/topluurunsilme"><i class="fas fa-trash text-danger "></i> Toplu Ürün Silme</a>
									</div>
								</div>
			...
			<div class="row arkaplan p-1 mt-2 pb-0">
				<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 border-right p-2 pt-3 geneltext bg-gradient-mvc">                    
					...
					<a class="fas fa-trash-alt text-danger float-left ml-2 "></a>
					<span>Ürün Ad</span>						
                </div><!-- Ürün Ad -->					
				<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 border-right p-2 pt-3 geneltext bg-gradient-mvc">                    
						<span>Kategori</span>						
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-2 p-0">                    
					...
					Form::Olustur("2",array("type"=>"checkbox",$value["id"],"name"=>"silme","class"=>"float-left ml-4")); 
					...
					echo'</div>								
								...
								<div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 text-dark kalinyap p-2 text-center">									
									<a href="'.URL.'/panel/urunGuncelle/'.$value["id"].'" class="fas fa-edit mt-1 guncelbuton"></a>									
									<a href="'.URL.'/panel/urunSil/'.$value["id"].'" class="fas fa-trash-alt ml-2  silbuton"></a>								
								</div>				   			
							</div> 						
						</div>';	  					
						endforeach;?>                   				
